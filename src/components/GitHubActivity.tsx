        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex justify-end mb-4">
            ...
            >
              ...
              <svg 
                className={`w-4 h-4 text-text-secondary group-hover:text-accent-primary transition-all duration-300 ${
          ...
          <div className={`bg-bg-card rounded-xl border border-border-primary transition-all duration-500 overflow-hidden ${
            isCollapsed ? 'max-h-40 opacity-70' : 'max-h-none opacity-100'
          }`}>
            <div className="p-6">
            {loading ? (
